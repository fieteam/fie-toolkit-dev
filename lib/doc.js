...
const log = require('fie-api').log('fie-toolkit-dev');
...
module.exports = function* () {
  ...
  if (resultBody && resultBody.errCode === 0) {
    log.success('文档发布成功，请到 http://fie.alibaba.net/ 查看您的模块信息');
  } else {
    log.error('文档发布失败', JSON.stringify(resultBody ? resultBody.errMsg : {}));
  }
};
